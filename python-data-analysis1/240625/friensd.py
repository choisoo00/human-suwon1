#fridends101.txt파일을 현재 friends.py 파일의 같은 폴더에 넣기
import os, re

print(os.getcwd())
#여러분들의 friends.py 저장경로
os.chdir(r'D:\human-edu1\python-data-analysis1\240625')

f = open('friends101.txt', 'r', encoding= 'utf-8') #프렌즈101 대본파일 내용 읽기 모드
script101 = f.read()
print(script101[:100]) #프렌즈101 대본 파일 내용 중 앞에서 부터 100개의 문자 가져오기
